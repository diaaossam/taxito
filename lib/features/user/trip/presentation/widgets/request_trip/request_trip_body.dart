...
class RequestTripBody extends StatelessWidget {
  ...
  const RequestTripBody({super.key, required this.onChangeIndex});
            ...
            children: [
              ...
              AppText(
                text: bloc.currentState == 0
                    ? context.localizations.startPoint
                    : context.localizations.endPoint,
                textSize: 14,
              ...
              CustomTextFormField(
                ...
                onTap: () async {
                  final response = await TripHelper().searchForLocation(
                    context: context,
                    isStart: true,
                  );
                  if (response != null) {
                    bloc.submitTripPointEvent(
                      mainLocationData: response,
                      isStart: true,
                    );
                  }
                },
              ...
              if (bloc.currentState == 1 || bloc.currentState == 2) ...{
                ...
                CustomTextFormField(
                  ...
                  onTap: () {
                    context.navigateTo(
                      const ChooseLocationScreen(isStart: false),
                      callback: (p0) {
                        if (p0 != null) {
                          bloc.submitTripPointEvent(
                            mainLocationData: p0,
