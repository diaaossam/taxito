import 'package:aslol/core/enum/time_enum.dart';
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: CustomTextFormField(
                        ...
                        onTap: () async {
                          ...
                          if (response != null) {
                            date.text =
                                TripHelper().formatTripDate(date: response);
                            setState(() => tripDateTime = tripDateTime.copyWith(
                                year: response.year,
                      ...
                      child: CustomTextFormField(
                        ...
                        onTap: () async {
                          ...
                          if (timeOfDay != null) {
                            ...
                            time.text =
                                TripHelper().formatTripTime(date: tripDateTime);
                          }
                        },
                      ),
                    ),
                ...
                CustomTextFormField(
                  readOnly: true,
                  controller:
                      TextEditingController(text: bloc.startLocation?.place),
                      ...
                      TripHelper().showPaymentMethods(
                          ...
                          paymentMethod: (p0) {
                            ...
                            TripParams tripParams = TripParams(
                              ...
                              paymentMethod: p0,
                              tripDate: TripHelper().formatDateTimeToApi(tripDateTime)['trip_date'],
                              tripTime: TripHelper().formatDateTimeToApi(tripDateTime)['trip_time'],
                            );
                            context.read<RequestTripBloc>().add(MakeTripRequestEvent(tripParams: tripParams));
                          });
                    }),
                SizedBox(
                  height: SizeConfig.bodyHeight * .02,
