...
import 'package:taxito/features/user/location/presentation/widgets/add_new_address_body.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) =>
              sl<LocationPickerCubit>()
                ..initLocationService(initAddress: address),
        ),
      ],
      child: Scaffold(
