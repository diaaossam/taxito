...
class DeliveryRatingWidget extends StatefulWidget {
  final Orders orders;
  ...
  @override
  State<DeliveryRatingWidget> createState() => _DeliveryRatingWidgetState();
}

class _DeliveryRatingWidgetState extends State<DeliveryRatingWidget> {
  ...
  void _updateResponse({num? rating, String? note}) {
    ...
    final response = {
      "rate_type": "delivery",
      if (_currentNote != null && _currentNote!.isNotEmpty)"review": _currentNote,
      "id":widget.orders.id,
            ...
            children: [
              ClipRRect(
                ...
                child: AppImage.network(
                  remoteImage: widget.orders.driver?.image,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    10.verticalSpace,
                    AppText(
                      text: widget.orders.driver?.name ?? "",
