...
import 'package:aslol/features/order/presentation/pages/success_order_screen.dart';
import 'package:aslol/features/order/presentation/widgets/cart/discount_design.dart';
import 'package:aslol/features/order/presentation/widgets/payment_item_design.dart';
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Column(
              ...
              children: [
                ...
                10.verticalSpace,
                LocationInfoWidget(
                  onLocationSelected: (data) => setState(() => shippingCost = data),
                )
              ],
            ),
          ),
          ...
          ListView.separated(
              ...
              itemBuilder: (context, index) {
                final paymentModel =
                    PaymentModel.allPayments(context: context,isCharge: true)[index];
              ...
              itemCount: PaymentModel.allPayments(context: context,isCharge: true).length),
          SizedBox(
            height: SizeConfig.bodyHeight * .02,
          ),
          const CustomDividerDesign(),
          ...
          BlocConsumer<CartCubit, CartState>(
            listener: (context, state) {
              if (state is PlaceOrderSuccess) {
                context.navigateTo(SuccessOrderScreen(
                  id: state.orderId,
                ));
                  ...
                  press: () {
                    if (paymentMethod == null) {
                      AppConstant.showCustomSnakeBar(context,
                          context.localizations.paymentValidation, false);
                      return;
                    }
                    CartModel cartModel = CartModel(
                      discountCode:
                          bloc.couponDiscount != 0 ? bloc.discount.text : null,
                      items: bloc.cartList,
