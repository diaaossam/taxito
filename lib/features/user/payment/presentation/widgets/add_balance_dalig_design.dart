...
import 'package:taxito/features/user/payment/presentation/bloc/balance/balance_cubit.dart';
                    ...
                    BlocConsumer<BalanceCubit, BalanceState>(
                      listener: (context, state) {
                        if (state is AddBalanceSuccess) {
                          ...
                          AppConstant.showCustomSnakeBar(
                            context,
                            context.localizations.balanceAddedSuccessfully,
                            true,
                          );
                        }
                      ...
                      builder: (context, state) {
                        return CustomButton(
                          ...
                          isActive: value != null,
                          text: context.localizations.addBalance,
                          press: () => context.read<BalanceCubit>().addBalance(
                            balance: num.parse(value.toString()),
                          ),
                        );
                      },
                    ),
