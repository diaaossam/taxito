...
import '../../../driver_main/presentation/cubit/driver_main/driver_main_cubit.dart';
...
class _TripHistoryScreenState extends State<TripHistoryScreen> {
  ...
  TripStatusEnum tripStatusEnum = TripStatusEnum.delivered;
            ...
            child: CustomScrollView(
              slivers: [
                CustomSliverAppBar(
                  ...
                  pressIcon: () => context
                      .read<DriverMainCubit>()
                      .changeBottomNavIndex(index: 0),
                ),
                SliverPadding(
