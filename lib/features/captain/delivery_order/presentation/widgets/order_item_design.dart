...
class _OrderItemDesignState extends State<OrderItemDesign> {
  ...
  void initState() {
    super.initState();
    // Get initial remaining seconds if this is a pending order with accept/reject buttons
          ...
          children: [
            Row(
              ...
              children: [
                ...
                10.horizontalSpace,
                AppText(
                  text: handleOrderTypeToString(
                    code: widget.orders.status!,
                  ),
                  fontWeight: FontWeight.w600,
                  textSize: 11,
                  color: context.colorScheme.tertiary,
            ...
            Row(
              ...
              children: [
                CircleAvatar(
                  backgroundImage:
                      NetworkImage(widget.orders.supplier?.profileImage ?? ''),
                ),
                10.horizontalSpace,
                Expanded(
                  child: Column(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      10.verticalSpace,
                      AppText(
                        text: widget.orders.address?.name ??
