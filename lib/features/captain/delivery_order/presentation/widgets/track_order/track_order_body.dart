...
import 'package:taxito/features/captain/delivery_order/presentation/widgets/track_order/order_info_card.dart';
import 'package:taxito/features/captain/delivery_order/presentation/widgets/track_order/order_persons_info.dart';
import 'package:taxito/features/captain/delivery_order/presentation/widgets/track_order/product_info_widget.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      backgroundImage:
                      NetworkImage(order.supplier?.profileImage ?? ''),
                    ),
                    10.horizontalSpace,
                    Expanded(
                      child: Column(
