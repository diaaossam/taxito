        ...
        Container(
          ...
          child: Row(
            children: [
              CircleAvatar(
                backgroundImage:
                    NetworkImage(orders.supplier?.profileImage ?? ""),
              ),
              8.horizontalSpace,
              Expanded(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AppText(text: orders.supplier?.name??"",fontWeight: FontWeight.w600,),
                    6.verticalSpace,
                    AppText(text: orders.supplier?.address??"",fontWeight: FontWeight.w600,),
                  ],
                ),
              ),
        ...
        Container(
          ...
          child: Row(
            children: [
              CircleAvatar(
                backgroundImage:
                NetworkImage(orders.user?.profileImage ?? ""),
              ),
              8.horizontalSpace,
              Expanded(
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AppText(text: orders.user?.name??"",fontWeight: FontWeight.w600,),
                    6.verticalSpace,
                    AppText(text: orders.user?.address??"",fontWeight: FontWeight.w600,),
                  ],
                ),
              ),
