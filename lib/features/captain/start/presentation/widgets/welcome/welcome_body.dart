      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              _buildChoice(
                press: () => setState(() => selectedType = UserType.user),
                type: UserType.user,
                context: context,
              ...
              20.horizontalSpace,
              _buildChoice(
                press: () => setState(() => selectedType = UserType.supplier),
          ...
          Row(
            children: [
              _buildChoice(
                press: () => setState(() => selectedType = UserType.driver),
              ...
              20.horizontalSpace,
              _buildChoice(
                press: () => setState(() => selectedType = UserType.delivery),
