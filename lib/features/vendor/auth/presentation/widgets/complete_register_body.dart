      ...
      body: FormBuilder(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            IdPhotoPicker(
              name: "frontId",
              initialImage: UserDataService().getUserData()?.commercialRegistration,
      ...
      bottomNavigationBar:
        ...
        builder: (context, state) {
          return Padding(
            ...
            child: CustomButton(
                text:widget.isUpdate ? context.localizations.update : context.localizations.createNewAccount,
                isLoading: state is RegisterUserLoading,
                press: () {
                  if (!_formKey.currentState!.saveAndValidate()) return;
                  if (profilePath == null && !widget.isUpdate) {
                    AppConstant.showCustomSnakeBar(context, context.localizations.profileImageValidation, false);
                    return;
                  }

                  final LocationEntity locationEntity =
                  _formKey.fieldValue("location");
