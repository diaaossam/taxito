...
class DeliveryOrderBody extends StatefulWidget {
  ...
  const DeliveryOrderBody({super.key, required this.showTitle, this.orderId});
                    ...
                    return BlocListener<SocketCubit, SocketState>(
                      ...
                      child: TabBarView(
                        ...
                        children: [
                          ...
                          DeliveryOrderList(
                            statusText: context.localizations.orderIsReady,
