...
import '../../../../../captain/delivery_order/domain/usecases/get_statics_use_case.dart';
import '../../../data/models/response/statics_model.dart';
...
class StaticsCubit extends Cubit<StaticsState> {
  ...
  Future<void> getAllStatics() async {
    ...
    emit(
      response.fold(
        (l) {
          return GetStaticsFailure(msg: l.msg);
        },
        (r) {
          staticsModel = r.data;
