              ...
              return SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    _buildStaticsItem(
                        context: context,
                        title: context.localizations.newOrders,
                        data: bloc.staticsModel!.newOrders.toString(),
                        press: () {},
                    ...
                    _buildStaticsItem(
                        ...
                        data: bloc.staticsModel!.completedOrders.toString(),
                        press: () {},
                    ...
                    _buildStaticsItem(
                        ...
                        data:
                            "${formatPrice(price: bloc.staticsModel!.totalProfit.toString())} ${context.localizations.iqd}",
                        press: () {},
                    ...
                    _buildStaticsItem(
                        ...
                        data: bloc.staticsModel!.rate.toString(),
                        press: () {},
